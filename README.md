These are the starting files used by [Coinless](https://www.coinlessmobile.com/) to create the main consumer facing website. The website is built using JAMstack. 
